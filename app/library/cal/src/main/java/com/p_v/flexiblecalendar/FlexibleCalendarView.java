...
public class FlexibleCalendarView extends LinearLayout implements
    ...
    private void init(AttributeSet attrs) {
        ...
        View controlView = LayoutInflater.from(context).inflate(R.layout.month_grid_layout_controls, null);

        ImageView leftArrow = (ImageView) controlView.findViewById(R.id.left_arrow);
        ImageView rightArrow = (ImageView) controlView.findViewById(R.id.right_arrow);
        monthTextView = (TextView) controlView.findViewById(R.id.month_text_view);
        ...
        weekdayDisplayAdapter = new WeekdayNameDisplayAdapter(getContext(), R.layout.week_header, startDayOfTheWeek);
        ...
        cal.set(getCurrentYear(), getCurrentMonth(), 1);
        monthTextView.setText(cal.getDisplayName(Calendar.MONTH, Calendar.LONG,
                context.getResources().getConfiguration().locale) + " " + getCurrentYear());
    }
    ...
    private void setAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            monthViewBackground = a.getResourceId(R.styleable.FlexibleCalendarView_monthViewBackground, android.R.color.white);
            weekViewBackground = a.getResourceId(R.styleable.FlexibleCalendarView_weekViewBackground, android.R.color.white);
